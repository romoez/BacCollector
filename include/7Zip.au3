...
;~ https://www.autoitscript.fr/forum/viewtopic.php?f=21&t=1943
...
;
; Author ........: Tlem
; Notes : The 14-11-2017 Addition of the compilation type test to avoid the case of the
; script compiled in x32 and run on an x64 environment using the bad DLL.
; ===============================================================================================================================
Func _7ZipStartup()
...
Func _7ZipAdd($hWnd, $sArcName, $sFileName, $sFileType = 0, $sHide = 0, $sCompress = 5, $sRecurse = 1, $sIncludeFile = 0, $sExcludeFile = 0, _
	...
	Local $HeaderEncode = " -mhe"
	If StringUpper(StringRight($sArcName, 3)) = "ZIP" Then $HeaderEncode = ""
	...
	If $sPassword Then $iSwitch &= " -p" & $sPassword & $HeaderEncode
