...
; #CHANGES# =====================================================================================================================
; By Moez   Added 3 functions: _SetAuthor, _SetCopyright, _SetCreator.
;           Replaced _Iif function by ternary operator.
;           Fixed encoding for letters with accent: https://www.autoitscript.com/forum/topic/118827-create-pdf-from-your-application/?do=findComment&comment=1438876
; By bdr529 https://www.autoitscript.com/forum/topic/118827-create-pdf-from-your-application/page/12/#comment-1158973
...
Global $PDF_COPYRIGHT = "AutoIt MIPDF"
Global $PDF_TITLE = @ScriptName
Global $PDF_SUBJECT = ""
Global $PDF_KEYWORDS = ""
Global $PDF_NAME = ""
...
;~ 	Next
    For $j = $FirstChar To $LastChar
        If $Widths[$j] <> 0 Then
            ...
            If Mod($j + 1, 16) = 0 Or $j = $LastChar Then
                __ToBuffer($sTemp)
                $sTemp = ""
            EndIf
        EndIf
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _SetAuthor
; Description ...: Set the author property of the pdf
; Syntax ........: _SetAuthor( [ $sAuthor ] )
; Parameters ....: $sAuthor              - [optional]  string value.
; Return values .: None
; Author(s) .....: Moez Romdhane (moez.romdhane@tarbia.tn)
; Modified ......:
; Remarks .......:
; Related .......:
; Link ..........: http://www.autoitscript.com/forum/topic/118827-create-pdf-from-your-application/
...
; Name ..........: _SetCopyright
; Description ...: Set the author property of the pdf
; Syntax ........: _SetCopyright( [ $sCopyright ] )
; Parameters ....: $sCopyright              - [optional]  string value.
; Return values .: None
; Author(s) .....: Moez Romdhane (moez.romdhane@tarbia.tn)
; Modified ......:
; Remarks .......:
...
; Example .......: No
; ===============================================================================================================================
Func _SetCopyright($sCopyright = "")
	$PDF_COPYRIGHT = $sCopyright
EndFunc   ;==>_SetCopyright

; #FUNCTION# ====================================================================================================================
; Name ..........: _SetCreator
; Description ...: Set the author property of the pdf
; Syntax ........: _SetCreator( [ $sCreator ] )
; Parameters ....: $sCreator              - [optional]  string value.
; Return values .: None
; Author(s) .....: Moez Romdhane (moez.romdhane@tarbia.tn)
; Modified ......:
; Remarks .......:
...
; Example .......: No
; ===============================================================================================================================
Func _SetCreator($sCreator = "")
	$PDF_CREATOR = $sCreator
EndFunc   ;==>_SetCreator
